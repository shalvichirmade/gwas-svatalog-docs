...
Based on the SV selected above, this table will display the corrsponding annotations describing this SV region. :doc:`annotationfile` explains the meaning of each column in detail.


Interactive Colocalization Plot
-------------------------------

This plot shows the colocalization of SNPs and a single SV. It will autopopulate when a SV is chosen from the SV table. 
