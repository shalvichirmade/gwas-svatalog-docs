...
Based on the SV selected in `SV Table`_, this table will display the corresponding annotations for the SV region. `This document <annotation>`_ explains the meaning of each column in detail.
