...
Based on the SV selected in `SV Table`_, this table will display the corresponding annotations for the SV region. :doc:`This document </guides/SV_Annotation_Table_Documentation.pdf>`_ explains the meaning of each column in detail.
